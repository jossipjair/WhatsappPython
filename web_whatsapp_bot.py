...
message_text='Hola mundo, es un mensaje de prueba bot whatsapp' # message you want to send
no_of_message=10 # no. of time you want the message to be send
moblie_no_list=[51934915804] # list of phone number can be of any length
